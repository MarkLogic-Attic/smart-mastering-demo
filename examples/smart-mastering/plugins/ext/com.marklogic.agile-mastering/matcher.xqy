...
{
  let $options := cts:uris('', (), cts:collection-query("mdm-match-options"))
  let $option-names := $options ! fn:replace(
    fn:replace(., "/com.marklogic.agile-mastering/options/algorithms/", ""),
    ".xml", ""
  )
  return
...
{
  fn:doc("/com.marklogic.agile-mastering/options/algorithms/"||$options-name||".xml")/matcher:options
};
...
)
{
  ...
  xdmp:document-insert(
    "/com.marklogic.agile-mastering/options/algorithms/"||$name||".xml", 
    $options,
    (xdmp:permission("mdm-admin", "update"), xdmp:permission("mdm-user", "read")),
    ("mdm-options", "mdm-match-options", "mdm-algorithm")
  )
};
